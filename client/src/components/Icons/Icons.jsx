    ...
    case "dollar":
      return (
        <svg
          ...
          className={`${styles.icons} ${iconClasses}`}
        >
          <path d="M479-126q-11 0-19-8t-8-19v-59q-51-7-85.5-32T312-313q-3-10 2-21t15-14q10-4 20 0t16 14q18 35 45.5 53.5T484-262q45 0 80.5-22.5T600-354q0-40-30.5-67T478-466q-86-26-121-63t-35-87q0-56 40.5-90.5T452-750v-57q0-11 8-19t19-8q11 0 19 8t8 19v57q31 2 60.5 17.5T618-687q6 10 2 21t-15 17q-8 4-17 2.5T571-657q-15-19-37-31t-54-12q-42 0-73 23.5T376-620q0 34 18.5 55.5T504-512q77 25 114.5 62t35.5 96q-2 64-44 101t-104 43v57q0 11-8 19t-19 8Z" />
        </svg>
      );
    case "booking":
      return (
